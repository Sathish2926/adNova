...
//         {/* INFLUENCER FORM */}
//         <div id="influencerForm" className="signup-form">
...
//           <button className="instagram-btn mb-3">
...
//         {/* BUSINESS FORM */}
//         <div id="businessForm" className="signup-form d-none">
//           <input className="form-control mb-3" placeholder="Business Name" />
//           <input className="form-control mb-3" placeholder="Owner Name" />
//           <input className="form-control mb-3" placeholder="Business Email" />
