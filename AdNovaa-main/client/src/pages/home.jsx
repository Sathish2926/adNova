  ...
  return (
    <>
      ...
      <div className="full-bg">
        ...
        >
          <div className="container" data-aos="fade-up">
            ...
            <p className="lead mt-3 mb-4">
              adNova helps brands find influencers who match their audience,
              vision & goals.
            </p>
            ...
            <div className="row g-5">
              <div className="col-md-4" data-aos="fade-up">
                <div className="service-box">
                  ...
                  <p>
                    Promote your business through verified influencers and gain
              ...
              >
                <div className="service-box">
                  ...
                  <p>
                    Safe, transparent collaboration with influencers for honest
                    results.
                  </p>
                </div>
              </div>
              ...
              >
                <div className="service-box">
                  <h4>Brand Growth</h4>
                  <p>
                    Grow your brand with analytics, reporting and influencer
                    tracking.
                  </p>
                </div>
              </div>
          ...
          <div className="row align-items-center">
            <div className="col-md-6" data-aos="fade-left">
              ...
              <p className="text-light">
                Smart, creative individuals ready to boost your brand with
                high-engagement content.
              </p>
            </div>

            <div
              className="col-md-6 d-flex gap-3 flex-wrap justify-content-center"
              data-aos="fade-right"
            >
              <img
                src="assets/images/Animation professionnelle de vos comptes….jpeg"
                className="info-img"
              />
              <img
                src="assets/images/Free photo influencer marketing collage _ Free….jpeg"
                className="info-img"
              />
              <img
                src="assets/images/A group of people in front of them is a list of….jpeg"
                className="info-img"
              />
            </div>
          </div>
          ...
          <div className="row g-4">
            <div className="col-md-4" data-aos="fade-up" data-aos-delay="0">
              <div className="biz-card">
                <img
                  src="assets/images/undefined (1).jpeg"
                  alt="business"
                />
              </div>
            </div>
            ...
            <div className="col-md-4" data-aos="fade-up" data-aos-delay="150">
              <div className="biz-card">
                <img
                  src="assets/images/undefined (3).jpeg"
                  alt="business"
                />
              </div>
            </div>
            ...
            <div className="col-md-4" data-aos="fade-up" data-aos-delay="300">
              <div className="biz-card">
                <img
                  src="assets/images/Photo colorful assortment of gents tshir….jpeg"
                  alt="business"
                />
              </div>
            </div>
        ...
        <section
          id="about"
          className="about-section py-5 text-center text-white"
          data-aos="fade-up"
        >
          <div className="container" data-aos="fade-up">
            ...
            <p className="fs-5 mx-auto" style={{ maxWidth: "800px" }}>
              ...
              transparent, secure, and creative platform for smooth
              collaborations.
            </p>
          </div>
        </section>
        ...
        <section
          id="contact"
          className="py-5 text-white text-center contact-section"
        >
          <div className="container" data-aos="fade-up">
            <h2 className="fw-bold mb-4">Contact Us</h2>
            <p className="fs-5 mb-3">We’re always here to help.</p>
            <p>
              Email: <strong>support@adnova.com</strong>
            </p>
            <p>
              Instagram: <strong>@adnova_official</strong>
            </p>
          </div>
        </section>
      </div>
