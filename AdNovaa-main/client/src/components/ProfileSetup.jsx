...
export default function ProfileSetup() { 
    ...
    const [infData, setInfData] = useState({
        ...
        instagramHandle: '', youtubeHandle: '', rateCard: ''
    });
                ...
                <form onSubmit={handleSubmit} className='profile-setup-form'>
                    {isBusiness ? (
                        ...
                        <>
                            ...
                            <input type="text" placeholder="Niche" required value={infData.niche} onChange={e => setInfData({...infData, niche: e.target.value})} />
                            ...
                            <div className="social-toggle-group">
                                <label className="social-checkbox">
                                    <input type="checkbox" checked={hasInsta} onChange={e => setHasInsta(e.target.checked)} /> Instagram
                                </label>
                                <label className="social-checkbox">
                                    <input type="checkbox" checked={hasYT} onChange={e => setHasYT(e.target.checked)} /> YouTube
                                </label>
                            </div>
